...
\begin{figure}[htbp]
	...
	\caption[Data sheet of the IMU component]{Partial data sheet of the IMU component. The No.117 register indicates that for one specific compnent, there are at most two selectable IIC addresses to use.}
